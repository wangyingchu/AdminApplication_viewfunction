...
public class AddNewConfigurationItemPropertyPanel extends VerticalLayout {
    ...
    public AddNewConfigurationItemPropertyPanel(UserClientInfo currentUserClientInfo){
        ...
        MainSectionTitle addNewPropertySectionTitle=new MainSectionTitle("Add Configuration Item Property");
        ...
        Label propertyInfoLabel=new Label(FontAwesome.INFO_CIRCLE.getHtml()+" "+"Property Information:", ContentMode.HTML);
        ...
        propertyNameTextField = new TextField("Property Name");
        propertyNameTextField.setRequired(true);
        propertyAttributeForm.addComponent(propertyNameTextField);

        propertyDataTypeField = new ComboBox("Property Data Type");
        ...
        propertyDataTypeField.setInputPrompt("Please select property data type");
        ...
        Label propertyValuesLabel=new Label(VaadinIcons.INPUT.getHtml()+" "+"Property Values:", ContentMode.HTML);
        ...
        addMoreValueButton.setDescription("Add More Value");
    ...
    private HorizontalLayout generateValueInputFieldLayout(String propertyDataType,boolean addRemoveButton){
        ...
        if(addRemoveButton) {
            ...
            removeCurrentFieldButton.setDescription("Remove This Value");
    ...
    private void addPropertyValues(){
        ...
        if(!inputtedValueValidateResult){
            Notification errorNotification = new Notification(userI18NProperties.
                    getProperty("Global_Application_DataOperation_DataValidateErrorText"),
                    "Please input valid data for all property values", Notification.Type.ERROR_MESSAGE);
            errorNotification.setPosition(Position.MIDDLE_CENTER);
            errorNotification.show(Page.getCurrent());
            errorNotification.setIcon(FontAwesome.WARNING);
            return;
        ...
        if(isExistProperty){
            Notification errorNotification = new Notification(userI18NProperties.
                    getProperty("Global_Application_DataOperation_DataValidateErrorText"),
                    "Property already exist", Notification.Type.ERROR_MESSAGE);
            errorNotification.setPosition(Position.MIDDLE_CENTER);
            errorNotification.show(Page.getCurrent());
            errorNotification.setIcon(FontAwesome.WARNING);
            return;
        ...
        Label confirmMessage=new Label(FontAwesome.INFO.getHtml()+" "+"Please confirm to add new property"+
            ...
            public void buttonClick(final Button.ClickEvent event) {
                ...
                if(addPropertyResult){
                    ...
                    Notification resultNotification = new Notification(userI18NProperties.
                            ...
                            "Add new configuration item property success", Notification.Type.HUMANIZED_MESSAGE);
                    resultNotification.setPosition(Position.MIDDLE_CENTER);
                    resultNotification.setIcon(FontAwesome.INFO_CIRCLE);
                    resultNotification.show(Page.getCurrent());
                }else{
                    Notification errorNotification = new Notification("Add New Configuration Item Property Error",
                            userI18NProperties.
        ...
        if(ApplicationConstant.DataFieldType_STRING.equals(currentSelectedPropertyDataType)){
            if(propertyValueInputFieldList.size()==1){
                ...
                for(int i=0;i<propertyValueInputFieldList.size();i++){
                    propertyValue[i]=((TextField)propertyValueInputFieldList.get(0)).getValue();
                }
                return propertyValue;
            }
